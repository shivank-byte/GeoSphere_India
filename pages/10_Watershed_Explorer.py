...
with c1:
    _watershed_river_title = {"Ganga": "Ganges", "Tapi": "Tapti River", "Chambal": "Chambal River", "Krishna": "Krishna River"}
    show_wiki_photo(_watershed_river_title.get(rdata["name"], rdata["name"]), caption=f"{rdata['name']} — reference photo (Wikipedia)")
    st.markdown(f"""
