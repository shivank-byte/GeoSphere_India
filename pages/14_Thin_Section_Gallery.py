...
with cc1:
    ...
    show_wiki_photo(comp["wiki"] + " hand specimen", caption=f"{comp['name']} — hand specimen view")
with cc2:
    st.markdown("<div style='color:#00d4ff;font-size:0.8rem;margin-bottom:4px;'>🔬 THIN SECTION (XPL)</div>", unsafe_allow_html=True)
    show_wiki_photo(comp["wiki"] + " thin section", caption=f"{comp['name']} — under crossed polars")
