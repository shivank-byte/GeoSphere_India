...
render_hero_image("Geology", "About & Archive", "CREDITS, DATA SOURCES & EASTER EGGS")
...
_credits = [
    ("🗺️","Geological Survey of India (GSI)","Mineral deposit locations, geological province boundaries, and Indian stratigraphic data.","https://www.gsi.gov.in"),
    ("🌍","USGS (United States Geological Survey)","Live worldwide earthquake feed and historical seismic event data.","https://earthquake.usgs.gov"),
    ("📷","Wikipedia / Wikimedia Commons","Photographs of minerals, rocks, thin sections, landforms, and locations (CC-licensed).","https://www.wikipedia.org"),
    ("🎓","BHU NEP Earth Science Syllabus","Semester-wise subject structure, unit topics, and reference reading lists.","https://www.bhu.ac.in"),
    ("🗾","OpenStreetMap / Overpass API","River centrelines and mountain-range geometry where live data is available.","https://www.openstreetmap.org"),
]
for em, name, desc, url in _credits:
    st.markdown(f"""
    <div class='glass-card' style='padding:11px 16px;margin-bottom:8px;display:flex;gap:12px;align-items:start;'>
        <span style='font-size:1.3rem;'>{em}</span>
        <div>
            <a href='{url}' target='_blank' style='color:#00d4ff;font-size:0.82rem;font-weight:600;text-decoration:none;'>{name} ↗</a>
            <div style='color:#94a3b8;font-size:0.74rem;margin-top:2px;line-height:1.5;'>{desc}</div>
        </div>
    </div>""", unsafe_allow_html=True)
st.caption("GeoSphere India is an independent educational project and is not officially affiliated with GSI, USGS, Wikipedia, or BHU.")
