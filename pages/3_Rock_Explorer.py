...
with hs_col1:
    ...
    show_wiki_photo(f"{hs_pick} hand specimen", caption=f"{hs_pick} — hand specimen")
with hs_col2:
    st.markdown("<div style='color:#00d4ff;font-size:0.8rem;margin-bottom:4px;'>🔬 THIN SECTION (XPL)</div>", unsafe_allow_html=True)
    show_wiki_photo(f"{hs_pick} thin section", caption=f"{hs_pick} — thin section, crossed polars")
