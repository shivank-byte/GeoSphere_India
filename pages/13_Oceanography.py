...
st.markdown("<div class='section-heading'>INDIAN OCEAN MONSOON REVERSAL</div>", unsafe_allow_html=True)
_season = st.radio("Season", ["☀️ Summer (SW Monsoon — Jun–Sep)", "❄️ Winter (NE Monsoon — Nov–Feb)"],
    horizontal=True, key="monsoon_season")
_is_summer = "Summer" in _season
st.markdown(f"""
